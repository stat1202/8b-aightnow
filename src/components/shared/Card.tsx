...
export default function Card(props: CardProps) {
  ...
  return (
    <>
      ...
      {type === 'News1' && news && (
        <div className="flex border-2 border-primary-100 w-[355px] h-[100px] items-center rounded-3xl justify-center">
          <div className="w-[323px] h-[52px] items-center flex">
            <div className="pr-8">
              <p className="b5 text-grayscale-400 mb-1">{newstime}</p>
              <span className="b2 text-grayscale-900 font-bold line-clamp-1">
                {news.title}
                {news.content}
              </span>
            </div>
        ...
        <div className="w-[388px] h-[360px] flex flex-col justify-center items-center ">
          <div className="w-[388px] h-[236px] flex justify-center rounded-t-2xl relative overflow-hidden">
            <Image
              ...
              alt="thumbnail"
              fill
              className="rounded-t-2xl transform transition-transform duration-700 ease-in-out hover:scale-125"
            />
          </div>
          <div className="w-[388px] h-[124px] flex flex-col rounded-b-2xl justify-center items-center shadow-md ">
            <p className="b3 font-medium px-6 overflow-hidden line-clamp-2 ">
              {news.title}
            </p>
        ...
        <div className="w-[590px] h-[640px] flex flex-col">
          ...
          <div className="w-full h-[200px] mb-4 relative flex flex-col overflow-hidden rounded-2xl">
            ...
            <div className="w-full h-[114px] absolute text-center bottom-0 inset-x-0 bg-gradient-to-t from-[rgba(63,63,63,1)] to-[rgba(63,63,63,0)]">
              <p className="b1 font-bold px-6 pt-6 pb-4 text-[#FFFFFF] overflow-hidden text-ellipsis whitespace-nowrap">
                {news.title}
              </p>
